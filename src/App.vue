...
<template>
	<div class="bg-gradient p-0 dark:bg-gray-800">
		<Bg>
			<template #containter>
				<svg
					class="relative rotate-12 mt-[68px] mx-auto opacity-80"
					height="80px"
					width="80px"
					fill="#DEA95A"
					version="1.1"
